                ...
                <div class="main-container container-fluid">
                  ...
                  <div class="card" id="view-list">
                    <div class="card-header bg-primary text-white">
                      <h3 class="card-title col-md-10">
                        <i class="fa fa-list me-2"></i> District List
                      </h3>
                    </div>
                  ...
                  <div id="add-form" style={{ display: "none" }}>
                    <div class="card">
                      <div class="card-header bg-primary text-white">
                        <h3 class="card-title col-md-10">
                          <i class="fa fa-plus-circle me-2"></i>Create District
                        </h3>
                      </div>
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-4">
                            <label class="form-label">
                              District Code<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              District Name<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
