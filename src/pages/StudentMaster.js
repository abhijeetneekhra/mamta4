                ...
                <div class="main-container container-fluid">
                  ...
                  <div id="add-form" style={{ display: "none" }}>
                    <div class="card">
                      <div class="card-header bg-primary text-white">
                        <h3 class="card-title col-md-10">
                          <i class="fa fa-plus-circle me-2"></i>Create Student
                        </h3>
                      </div>
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-4">
                            <label class="form-label">
                              Student Code<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Student Name<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              School<span class="text-red">*</span>
                            </label>
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              {" "}
                              Fathers Name<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Mobile No.<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Total Question<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Attempted Question<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Neatness<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-md-4">
                            <label class="form-label">
                              Score<span class="text-red">*</span>
                            </label>
                            <input
                              type="text"
                              class="form-control"
